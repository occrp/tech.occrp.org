...
These sites collect signals from a public high-frequency radio band, primarily for use by air-traffic control systems and other aircraft, known as the ADS-B system.  ADS-B signals can be monitored with any appropriately tuned antenna – you can make one at home! 
...
Like most aircraft, Mr. Abramovich’s Boeing regularly, though not always, transmits its location along with various other data about the aircraft on the ADS-B system described above.  Curious about Mr. Abramovich’s travels, we can input the tail number of his 767, visible from photographs as ‘P4-MES’, into one of the sites above.  Unfortunately, we would find no records of his travels, as they have presumably been redacted.  

While we could monitor his plane in realtime on the ADSBExchange site, providing historical travel records are not a function of their public-facing operations.  The algorithms and the database described above tell a different story, however.  Among many other travels, we know his jet visited the area of the British Virgin Islands several times in early 2017, including this trip (pictured right) from New Jersey on February 17 2017, staying until February 27.  Similar trips occured on January 3, and March 24, and December 22.
